...
min = 30; # Palabras que aparezcan menos de min veces se eliminaran
...
hold off;
plot(50:50:1000, trainPor, 'color', 'b');
hold on;
plot(50:10:1000, valPor, 'color', 'g');

plot(50:10:1000, trainPorn, 'color', 'red');
plot(50:10:1000, valPorn, 'color', 'black');
hold off;
